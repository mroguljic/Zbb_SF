...
SELECTION_DIR       = "/users/mrogul/Work/Zbb_SF_py3/Zbb_SF/results/selection/"
#Where to store skimmed NanoAODs
SKIM_DIR            = "/STORE/matej/Zbb_skims/v9_py3/"
#Where to store condor logs for selection jobs
SELECTION_JOB_DIR   = "/users/mrogul/Work/Zbb_SF_py3/Zbb_SF/condor/selection_jobs"
#Where to store condor logs for skimming jobs
SKIM_JOB_DIR        = "/users/mrogul/Work/Zbb_SF_py3/Zbb_SF/condor/skim_jobs"
...
TEMPLATE_JOB_DIR    = "/users/mrogul/Work/Zbb_SF_py3/Zbb_SF/condor/template_jobs/"
